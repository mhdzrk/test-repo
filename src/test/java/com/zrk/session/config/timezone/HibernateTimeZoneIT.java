package com.zrk.session.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.zrk.session.IntegrationTest;
import com.zrk.session.repository.timezone.DateTimeWrapper;
import com.zrk.session.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    public void setup() {
        ...
        dateTimeFormatter =
            DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss.S").withZone(ZoneId.of(zoneId));
