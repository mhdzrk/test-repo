package com.zrk.session.web.rest;

import static com.zrk.session.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.zrk.session.IntegrationTest;
import com.zrk.session.config.Constants;
import com.zrk.session.domain.User;
import com.zrk.session.repository.AuthorityRepository;
import com.zrk.session.repository.UserRepository;
import com.zrk.session.security.AuthoritiesConstants;
import com.zrk.session.service.UserService;
import com.zrk.session.service.dto.AdminUserDTO;
import com.zrk.session.service.dto.PasswordChangeDTO;
import com.zrk.session.service.dto.UserDTO;
import com.zrk.session.web.rest.vm.KeyAndPasswordVM;
import com.zrk.session.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    void testSaveAccount() throws Exception {
        ...
        User updatedUser = userRepository
            .findOneWithAuthoritiesByLogin(user.getLogin())
            .orElse(null);
    ...
    void testSaveExistingEmailAndLogin() throws Exception {
        ...
        User updatedUser = userRepository
            .findOneByLogin("save-existing-email-and-login")
            .orElse(null);
    ...
    void testChangePasswordWrongExistingPassword() throws Exception {
        ...
        User updatedUser = userRepository
            .findOneByLogin("change-password-wrong-existing-password")
            .orElse(null);
