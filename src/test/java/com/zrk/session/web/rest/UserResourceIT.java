...
import com.zrk.session.domain.Authority;
...
import com.zrk.session.service.mapper.UserMapper;
...
class UserResourceIT {
    ...
    void getUser() throws Exception {
        ...
        assertThat(cacheManager.getCache(UserRepository.USERS_BY_LOGIN_CACHE).get(user.getLogin()))
            .isNull();
        ...
        if (!(cacheManager instanceof NoOpCacheManager)) {
            assertThat(
                cacheManager.getCache(UserRepository.USERS_BY_LOGIN_CACHE).get(user.getLogin())
            )
                .isNotNull();
        }
    }
