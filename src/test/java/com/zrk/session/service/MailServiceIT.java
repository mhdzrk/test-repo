...
class MailServiceIT {
    ...
    private static final Pattern PATTERN_LOCALE_3 = Pattern.compile(
    ...
    void testSendMultipartEmail() throws Exception {
        ...
        MimeBodyPart part = (MimeBodyPart) (
            (MimeMultipart) mp.getBodyPart(0).getContent()
        ).getBodyPart(0);
    ...
    private String getJavaLocale(String langKey) {
        ...
        if (matcher3.matches()) {
            javaLangKey =
                matcher3.group(1) + "_" + matcher3.group(2) + "_" + matcher3.group(3).toUpperCase();
        }
        return javaLangKey;
    }
}
