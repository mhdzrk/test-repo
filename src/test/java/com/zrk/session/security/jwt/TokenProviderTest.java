package com.zrk.session.security.jwt;
...
class TokenProviderTest {
    ...
    void testKeyIsSetFromSecretWhenSecretIsNotEmpty() {
        ...
        assertThat(key)
            .isNotNull()
            .isEqualTo(Keys.hmacShaKeyFor(secret.getBytes(StandardCharsets.UTF_8)));
    }
    ...
    void testKeyIsSetFromBase64SecretWhenSecretIsEmpty() {
        ...
        assertThat(key)
            .isNotNull()
            .isEqualTo(Keys.hmacShaKeyFor(Decoders.BASE64.decode(base64Secret)));
    }
